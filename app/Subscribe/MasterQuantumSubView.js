                    ...
                    if (resultArray.fetch_flag == "1") {
                        ...
                        setTimeout(function () {
                            ...
                            Alert.alert(resultArray.rsp_title, resultArray.rsp_msg, [{
                                ...
                                onPress: () => {
                                    global.TAB_INDEX = 2;
                                    this.props.navigation.navigate('QiCoilTabNavigator', { transition: 'bottomUp', payment: 2 });
                                },
                                style: 'cancel'
                            }])
                        }.bind(this), 2000);
                ...
                <LinearGradient
                    ...
                    <View style={[global.FULL_DISPLAY ? Common.marginTop50 : Common.marginTop30, Common.flexRow, Common.alignItmCenter]}>
                        ...
                        <View style={[Common.flex07, Common.justifyCenter, Common.alignItmCenter]}>
                            <Text style={[AppCommon.h3, Colors.whiteFnColor, Input.textCenter, Input.textBold]}>{this.state.categoryName}</Text>
                        </View>
