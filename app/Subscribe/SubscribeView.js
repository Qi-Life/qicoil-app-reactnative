...
export default class SubscribeView extends Component {
                            ...
                            Alert.alert(resultArray.rsp_title, resultArray.rsp_msg, [{
                                ...
                                onPress: () => {
                                    if (this.state.callType == "SettingsTab") {
                                        ...
                                        global.TAB_INDEX = 0;
                                        this.props.navigation.navigate('QiCoilTabNavigator', { transition: 'bottomUp', payment: 6 });
                                    }
                                },
                                style: 'cancel'
                            }])
    ...
    async checUserTrial() {
        const url = global.CHECK_USERSUB_TRIAL + `?user_id=57335&sub_id=resonize.quantum.trial.annual`;
        try {
                        ...
                        <View style={[AppCommon.container, Common.paddingHorizontal30]}>
                            ...
                            <View style={[Common.marginTop120, Common.justifyCenter, Common.alignItmCenter]}>
                                <TouchableHighlight
                                    ...
                                    <Text style={[AppCommon.h4, Colors.whiteFnColor, Input.fontBold]}>
                                        {this.state.is_trial ? 'Subscribe': 'Try Free & Subscribe'}
                                    </Text>
                                </TouchableHighlight>
                            </View>
